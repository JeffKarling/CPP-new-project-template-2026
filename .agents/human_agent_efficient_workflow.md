...
```
┌────────────────────────────────────────────────────────┐
│ 1. Refactoring, Claude Sonnet, Refactoring Specialist  │
...
└───────────────────────────┬────────────────────────────┘
                            ...
                            ▼
┌────────────────────────────────────────────────────────┐
│ 2. Optimization, Gemini Pro, Performance Engineer      │
...
└───────────────────────────┬────────────────────────────┘
                            ...
                            ▼
┌────────────────────────────────────────────────────────┐
│ 3. Validation, Gemini Flash, Test Engineer             │
...
1. Phase 1, Refactoring: Initialize a session with Claude Sonnet. Activate the Refactoring Specialist role. Direct the model to restructure files and update CMake rules.
2. Phase 2, Optimization: Initialize a session with Gemini Pro. Activate the Performance Engineer role. Direct the model to run custom profile presets and optimize hot paths.
3. Phase 3, Validation: Initialize a session with Gemini Flash. Activate the Test Engineer role. Direct the model to run the verification suite and verify all test targets under GNU, oneAPI, and Clang compilers.
